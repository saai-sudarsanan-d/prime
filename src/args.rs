...
#[derive(Parser,Debug)]
#[command(author="Saai Sudarsanan",version="1.0.0",about="A CLI based Task Driven Workspace")]
...
pub struct CreateArgs{
    /// The task title
    #[arg(short='t',long="title",value_name="TASK NAME")]
    ...
    #[arg(short='d',long="deadline",value_name="DEADLINE",default_value_t=("2d").to_string())]
    pub deadline: String,

    /// Priority of this task (0 <= p < 4)
    #[arg(short='p',long="priority",value_name="PRIORITY",default_value_t=0)]
    pub priority: u8,
}
...
pub struct ReadArgs {
    ...
    /// Change count value
    #[arg(long="count",short='c',value_name="COUNT",default_value_t=20)]
    pub count: i32
}
...
pub struct UpdateArgs{
    ...
    #[arg(long="title",short='o',value_name="TASK NAME")]
    pub task_name: Option<String>,
